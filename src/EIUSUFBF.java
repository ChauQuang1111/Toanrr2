...
class EIUSUFBF {
	...
	public static void main(String[] args) throws IOException {
		...
		int leastFriend = reader.nextInt();
		Vertex[] FriendGraph = readGraph(nVertices, nEdges);
		for (Vertex v : FriendGraph) {
			sb.append(v.id+" ");
			for (Vertex j : v.adjecentVertices) {
				if (j.getDegree()< leastFriend) {
					sb.append(j.id+" ");
				}
			}
			sb.append("\n");
